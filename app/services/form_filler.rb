...
class FormFiller
  ...
  def take_screenshot_and_store
    ...
    job_app = JobApplication.first # Replace with your actual job_app using the id from the initialize method
    job_app.screenshot.attach(io: file, filename: 'screenshot.png', content_type: 'image/png')
